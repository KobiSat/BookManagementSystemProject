...
namespace BookManagementSystem.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        // POST: api/books
        /// <summary>
        /// Creates new book entry, id will be auto-generated by db, even if its accidentaly givven.
        /// </summary>
        ...
        public async Task<ActionResult<Book>> CreateNewBookEntry([FromBody] Book book)
        {
            ...
            book.Id = 0;  // Force auto-generated ID
        ...
        [HttpGet("search")]
        public async Task<ActionResult<IEnumerable<Book>>> SearchBooks( [FromQuery, StringLength(200)] string title = "", [FromQuery, StringLength(100)] string author = "")
        {
            var books = await _context.Books
                .Where(b => (string.IsNullOrEmpty(title) || EF.Functions.Like(b.Title, $"%{title}%")) &&
                            (string.IsNullOrEmpty(author) || EF.Functions.Like(b.Author, $"%{author}%")))
                .ToListAsync();
